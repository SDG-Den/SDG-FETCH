...
## Documentation
- [ ] Verify all 45 logos documented/present
- [ ] Verify all 49 presets documented
- [ ] Remove specific counts from docs

## Testing
- [ ] All logo presets render
- [ ] All display presets render
- [ ] `sdgfetch-conf` interactive configurator
- [ ] Runs without error on terminal startup

## Changes
- [ ] Verify logo file paths are correct
